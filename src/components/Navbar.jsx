      ...
      {currentUser ? (
        <div className='flex items-center gap-2 ml-2'>
          ...
          <button
            ...
            className = 'border border-gray-300 text-gray-600 px-3 py-2 rounded-full text-xs font-bold hover:bg-gray-100 transition-color'>
            Logout
          </button>
        </div>
        ) : (
          ...
          text-sm font-bold hover:bg-orange-700 transition-colors ml-2'>
            Login
          </button>
        )
        }
